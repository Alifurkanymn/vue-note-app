...
export default {
  ...
  methods:{
      deleteNote(post, id){
          axios.delete(`https://vue-note-app-be493-default-rtdb.firebaseio.com/note/${id}`,)
          .then(response=>{
